...
- (void)requestMergeStream: (int)retryCount {
    NSDictionary *mergeParams = [self createMergeParams];
...
// 连麦合流参数
- (NSDictionary*)createMergeParams {
    ...
    for (PusherInfo *pusherInfo in _roomInfo.pusherInfoArray) {
        [subStreamIds addObject:[self getStreamIDByStreamUrl:pusherInfo.playUrl]];
    }

...
@implementation RTCMsgListTableView
{
...
- (void)appendMsg:(RTCMsgModel *)msgModel {
    ...
    msgModel.attributedMsgText = [RTCMsgListTableViewCell getAttributedStringFromModel:msgModel];
...
- (CGFloat)calculateTotalCellHeight {
    ...
    for (RTCMsgModel *model in _msgArray) {
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.row < _msgArray.count) {
        RTCMsgModel *msgModel = _msgArray[indexPath.row];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    RTCMsgListTableViewCell *cell = (RTCMsgListTableViewCell *)[self dequeueReusableCellWithIdentifier:cellID];
    if (cell == nil) {
        cell = [[RTCMsgListTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellID];

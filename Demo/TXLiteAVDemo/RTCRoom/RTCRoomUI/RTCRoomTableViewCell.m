...
@interface RTCRoomTableViewCell() {
...
@implementation RTCRoomTableViewCell
...
- (void)layoutSubviews {
    ...
    _roomNameRightLabel.frame = CGRectMake(100, 20, 200, 20);

    _roomIDLeftLabel.frame = CGRectMake(20, 50, 200, 20);
    _roomIDRightLabel.frame = CGRectMake(100, 50, 200, 20);
    
    _memberNumLeftLabel.frame = CGRectMake(20, 80, 200, 20);
    _memberNumRightLabel.frame = CGRectMake(100, 80, 200, 20);

...
#define kHttpServerAddrDomain           @"https://lvb.qcloud.com/weapp/double_room"
...
- (void)viewDidLoad {
    ...
    [httpSession POST:kHttpServerAddr_GetIMLoginInfo parameters:param progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
        ...
        // 初始化RTCRoom
        [weakSelf.rtcRoom init:kHttpServerAddrDomain accountInfo:userInfo withCompletion:^(int errCode, NSString *errMsg) {
